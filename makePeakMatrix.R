...
p = add.argument(p, arg="--vanilla", help="The input RDa/RDS images contain only the table data frames and not Chicago objects", default="x")
p = add.argument(p, arg="--digestmap", "Full path to digest map file; will override settings from ChicagoData even if provided. Required for --vanilla", default=NA) 
p = add.argument(p, arg="--baitmap", "Full path to bait map ID file; will override settings from ChicagoData even if provided. Required for --vanilla", default=NA) 
