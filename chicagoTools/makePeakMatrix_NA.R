...
p = add_argument(p, arg="--setzero", help = "By default interactions absent in a sample/condition are given score NA. If flagged - these interactions will receive a score of 0 for a corresponding sample/replicate.", 
                flag = T)
