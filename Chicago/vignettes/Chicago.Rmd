...
Second, run the fitDistCurve.R script. As an example, if we had three biological replicates of mESC cells, we might run the following script in BASH:
...
[Input files required](#input-files-required) section. Some example weights are provided in the package:
...
```{r}
weightSettings <- file.path(weightsPath, "GM12878-3reps.settings")
