...
WARNING: The data set used in this tutorial comes from the package *PCHiCdata*. This package contains a small part of the real data set (two chromosomes) from Schoenfelder et al [@Schoenfelder2015] (note that this paper used a different interaction calling algorithm and we are only reusing raw data from it). Do not use any of these sample input data for purposes other than training. 
